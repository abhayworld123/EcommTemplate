...
type ImportType = 'products' | 'offers' | 'site-config';
  ...
  const handleFileUpload = async (type: ImportType, file: File) => {
    ...
    try {
      ...
      setMessages((prev) => ({
        ...
        [type]: {
          type: 'success',
          text: `Successfully imported ${count} ${type === 'site-config' ? 'site configuration' : type}!`,
        },
      }));
    } catch (error) {
          ...
          {tabs.map((tab) => (
            ...
            >
              ...
              <div className="mb-6 rounded-lg bg-gray-50 p-4">
                <h3 className="mb-2 text-sm font-semibold text-gray-700">CSV Format:</h3>
